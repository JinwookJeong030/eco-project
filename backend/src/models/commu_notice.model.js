...
//     sql.query('SELECT commu_notice.* , commu.commu_id FROM commu_id, commu WHERE commu_id = '+commu_id+" ", (err, res) => {
//       if (err) {
...
//     sql.query('SELECT commu_notice.* FROM commu_notice WHERE cn_id ='+ cn_id +';', (err,res) =>{
//       if(err) {
//         console.log('error:',err);
//         result(err,null);
//         return;
